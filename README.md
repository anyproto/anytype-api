...
> [!Note]
> For local search functionality to work, you must run `bun run build` (and then `bun run serve`). The search index is generated during the build process and is not available in development mode.
