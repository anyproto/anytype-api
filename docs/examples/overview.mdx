...
- **[Python Client for Anytype](/docs/examples/community/charlesneimog-anytype-client)** - ⭐ 105 stars
- **[Save to Anytype (Browser Extension)](/docs/examples/community/lazjedi-save-to-anytype)** - ⭐ 38 stars
- **[Anytype Toolbox](/docs/examples/community/stevelr-anyr)** - ⭐ 28 stars
- **[Anytype Rust SDK](/docs/examples/community/stevelr-anytype)** - ⭐ 28 stars
...
- **[Anytype Toolbox](/docs/examples/community/stevelr-anyr)** (⭐ 28) - CLI and MCP Server for Anytype: manage spaces and objects, edit documents in Markdown, back up and restore, chat
...
- **[n8n Anytype Node](/docs/examples/community/splch-n8n-nodes-anytype)** (⭐ 27) - An n8n community node for the Anytype API.

#### SDKs

- **[Anytype Rust SDK](/docs/examples/community/stevelr-anytype)** (⭐ 28) - An ergonomic Anytype API client in Rust. Unifies HTTP and gRPC backends.
- **[Python Client for Anytype](/docs/examples/community/charlesneimog-anytype-client)** (⭐ 105) - A Python client library for interacting with the Anytype API
...
- **[AnyTask](/docs/examples/community/tumypmyp-any-task)** (⭐ 6) - A Cross-Platform Client for Anytype written with Rust and Dioxus

#### Extensions

- **[Save to Anytype (Browser Extension)](/docs/examples/community/lazjedi-save-to-anytype)** (⭐ 38) - Save important web pages with your selected text in Markdown format to Anytype. Lightweight and easy-to-use alternative web clipper.
